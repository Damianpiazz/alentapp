...
const boolOptions = createListCollection({
    items: [
                ...
                <Flex justify="space-between" align="center">
                    <Stack gap="1">
                        ...
                        <Text color="fg.muted" fontSize="md">
                            Gestiona las disciplinas deportivas del club.
                        </Text>
                    </Stack>
                                ...
                                {sports.map((sport) => (
                                    ...
                                    >
                                        ...
                                        <Table.Cell
                                            ...
                                            textAlign="end"
                                        >
                                            ${sport.additional_price.toFixed(2)}
                                        </Table.Cell>
