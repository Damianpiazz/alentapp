...
2. **Caso de Uso**: `DeleteEquipmentLoanUseCase` (Comprueba existencia previa e inscripciones activas vía `findById` y delega la eliminación).
...
2. Crear `DeleteEquipmentLoanUseCase` asegurando el chequeo de inscripciones activas antes del borrado físico.
